...
const Roster = (props) => {
  ...
  props.roster.forEach(character => 
    characterCards.push(<Character key={character.name} character={character} handleDelete={props.handleDelete} handleLevelUpdate={props.handleLevelUpdate} handleGoldUpdate={props.handleGoldUpdate} />)
  ) 
  return (
